...
function changeColor() {
    ...
    */
    ...
    // Creates constants for all dropdown navigation links
    const dropNavLinks = document.querySelectorAll('a.dropbtn');
    ...
    if(randoNum == 1) { // Cotton Candy Theme
        ...
        for (let i = 0; i < navLinks.length; i++) {
            ...
            navLinks[i].style.backgroundColor = '#d0e1e8c5'
        }
        // Colors the links for the dropdown nav bar
        for (let i=0; i < dropNavLinks.length; i++) {
            dropNavLinks[i].style.color = '#a0b4c2'
        }
        ...
        for (let i = 0; i < navLinks.length; i++) {
            ...
            navLinks[i].style.backgroundColor = '#e8f0d5d3'
        }
        // Colors the links for the dropdown nav bar
        for (let i=0; i < dropNavLinks.length; i++) {
            dropNavLinks[i].style.color = '#7a9c57c0'
        }
        ...
        for (let i = 0; i < navLinks.length; i++) {
            ...
            navLinks[i].style.backgroundColor = '#f5dfe3fa'
        }
        // Colors the links for the dropdown nav bar
        for (let i=0; i < dropNavLinks.length; i++) {
            dropNavLinks[i].style.color = '#b8acc5'
        }
        ...
        for (let i = 0; i < navLinks.length; i++) {
            ...
            navLinks[i].style.backgroundColor = '#e2d4e0'
        }
        // Colors the links for the dropdown nav bar
        for (let i=0; i < dropNavLinks.length; i++) {
            dropNavLinks[i].style.color = '#7c7e9de7'
        }
        ...
        for (let i = 0; i < navLinks.length; i++) {
            ...
            navLinks[i].style.backgroundColor = '#dde0cce5'
        }
        // Colors the links for the dropdown nav bar
        for (let i=0; i < dropNavLinks.length; i++) {
            dropNavLinks[i].style.color = '#91a897'
        }
